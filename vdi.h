 ...
 struct __attribute__ ((packed))vdi
  {
    ...
    /*  0*/ unsigned int	hdr[16];
    /* 64*/ unsigned int	imgsignature;		/* VDI_HEADER_MAGIC		*/
    /* 68*/ unsigned int	version;	/* VDH_HEADER_MAJOR/MINOR	*/
    ...
    /*340*/ unsigned int	offsetblock;		/* offset to block info		*/
    /*344*/ unsigned int	offsetdata;		/* offset to data		*/
    ...
    /*376*/ unsigned int blocksize;	/* Size of a block: 1M		*/
